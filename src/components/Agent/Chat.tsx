...
export default function Chat() {
  ...
  return (
    <div className="p-4 max-w-2xl mx-auto">
      ...
      <div className="border p-4 mb-4 min-h-[100px] bg-gray-50 rounded">
        {response || 'Ask me something about the products or orders...'}
      </div>
      <div className="flex gap-2">
        <input className="flex-1 border p-2 rounded" value={message} onChange={e => setMessage(e.target.value)} placeholder="Type your message..." />
